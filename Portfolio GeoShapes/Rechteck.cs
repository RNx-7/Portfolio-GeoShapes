...
{
    public class Rechteck(Linie a, Linie b, Linie c, Linie d) : IGeometrischeForm
    {
        ...
        /// <summary>Berechnet den Umfang des Rechtecks: 2*(a+b).</summary>
        /// <returns>Umfang >= 0.</returns>
        /// public double BerechneUmfang() { /* ... */ } // Rechteck
